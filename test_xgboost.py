...
if __name__ == "__main__":
    ...
    compare_density_prf(radii=X_np[:,scaled_radii_loc], act_mass_prf_all=density_prf_all_within, act_mass_prf_orb=density_prf_1halo_within, mass=ptl_mass, orbit_assn=test_preds, prf_bins=bins, title = model_name, show_graph = False, save_graph = True, save_location = plot_save_location)
