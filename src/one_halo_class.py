...
from src.utils.ML_fxns import setup_client,get_combined_name,make_preds, get_model_name, get_feature_labels
from src.utils.util_fxns import create_directory,load_SPARTA_data,load_ptl_param, load_config, load_ML_dsets, reform_dset_dfs,split_sparta_hdf5_name
...
search_rad = config_params["DSET_CREATE"]["search_radius"]
...
if __name__ == "__main__":   
    ...
    for curr_test_sims in test_sims:
        for sim in curr_test_sims:
            ...
            plot_halo_slice_class(curr_ptl_pos,preds,curr_orb_assn,use_halo_pos,use_halo_r200m,plot_loc,title=sim+"_")
